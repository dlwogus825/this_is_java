...
public class ServerMain extends Thread implements com.mjc813.server.ServerChatInterface {
    ...
    private Set<com.mjc813.server.ServerChatSocket> lobby;

    public ServerMain() {
//		this.chatRooms = new LinkedList<>();
        this.chatRooms = Collections.synchronizedMap(new HashMap<Long, ChatRoom>());
        this.lobby = Collections.synchronizedSet(new HashSet<com.mjc813.server.ServerChatSocket>());
        try {
...
//				ServerChatSocket scs = new ServerChatSocket(cu, this);
                com.mjc813.server.ServerChatSocket scs = new com.mjc813.server.ServerChatSocket(cu, this.lobby);
                scs.start();
    ...
    private void printLobby() {
        for ( com.mjc813.server.ServerChatSocket scs : this.lobby ) {
            System.out.println(scs.getChatUser());
        }
    }

    @Override
    public void removeChatUser(com.mjc813.server.ServerChatSocket scs) {
